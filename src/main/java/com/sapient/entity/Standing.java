...
public class Standing implements Serializable {
    ...
    public void setHome_promotion(String home_promotion) {
        this.home_promotion = home_promotion;
    }
    ...
    public String getAway_promotion() {
        return away_promotion;
    }

    public void setAway_promotion(String away_promotion) {
        this.away_promotion = away_promotion;
    }
